...
// url do filme: https://www.omdbapi.com/?t=mummy&apikey=9dc6b2a1
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        String buscaFilme = "";
        // criando uma lista e pegar cada titulo que conseguir converter e salvar na lista
        ...
        while (!buscaFilme.equalsIgnoreCase("sair")) {
            ...
            // se o usuario logo de cara digitou sair temos que sair do programa
...
//       vamos ter que fazer uma serealização: anotação no campos nome va para o arquivo titulo e faça essa serealização
        ...
        // vamos transforma a lista no json para salvar
